...
namespace EShopSystem.Controllers
{
    public class InvoicesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "InvoiceId,InvoiceNumber,InvoiceDate,CustomerId,EmployeeId,InvoiceTotal,IsPaid,PaymentModeId")] Invoice invoice)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "InvoiceId,InvoiceNumber,InvoiceDate,CustomerId,EmployeeId,InvoiceTotal,IsPaid,PaymentModeId")] Invoice invoice)
        {
            if (ModelState.IsValid)
            {
